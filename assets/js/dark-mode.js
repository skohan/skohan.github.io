...
const LIGHT_THEME_PATH = "https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css";

const DARK_STYLE_LINK = document.getElementById("theme-style");
const THEME_TOGGLER = document.getElementById("theme-toggler");

let isDark = (LOCAL_META_DATA && LOCAL_META_DATA.isDark) ? true: false;
